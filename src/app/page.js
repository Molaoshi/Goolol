    ...
    <div className="flex flex-col h-screen justify-between">
      <main className="flex justify-center w-screen ">
        <div className=" flex flex-col items-center max-w-2xl w-[80%] ">
          ...
          <div className=" mt-10 w-[90%] border rounded-full overflow-hidden">
      ...
      <footer>
        <div className="p-1 bg-[#d9d9d9] w-screen mb-5">
          <div className=" flex justify-center">
            <div>
              <img onClick={() => router.push('https://twitter.com/?lang=en')} className=" cursor-pointer w-12 mx-2" src="/x-logo.svg" alt="" />
            </div>
            <div>
              <img onClick={() => router.push('https://www.youtube.com/')} className=" cursor-pointer w-12 mx-2" src="/youtube-logo.svg" alt="" />
            </div>
            <div>
              <img onClick={() => router.push('https://discord.gg/zvaVZJmz53')} className=" cursor-pointer w-12 mx-2" src="/discord-logo.svg" alt="" />
            </div>
            <div>
              <img onClick={() => router.push('https://t.me/+46DhWjOrw-5jZThl')} className=" cursor-pointer w-12 mx-2" src="/telegram-logo.svg" alt="" />
            </div>
          </div>
        </div>
      </footer>
